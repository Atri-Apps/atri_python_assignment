...
class Atri:
	def __init__(self, state: Any):
		...
		self.unique_view_chart = state["unique_view_chart"]
	...
	@property
	def unique_view_chart(self):
		self._getter_access_tracker["unique_view_chart"] = {}
		return self._unique_view_chart
	@unique_view_chart.setter
	def unique_view_chart(self, new_state):
		self._setter_access_tracker["unique_view_chart"] = {}
		global default_state
		self._unique_view_chart = BarChart(new_state, default_state["unique_view_chart"])
	...
	def _to_json_fields(self):
		return {
			...
			"unique_view_chart": self._unique_view_chart,
